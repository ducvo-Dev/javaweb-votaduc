...
<div class="row no-gutters">
	...
	<div class="home-category-banner bg-light-orange">
		<h5 class="title">Các mặt hàng máy móc cho các nhà sản xuất</h5>
		<p>Sản phẩm mới lạ được chọn. </p>
		<a href="#" class="btn btn-outline-primary rounded-pill">Xem Ngay</a>
		<img src="resources/images/items/14.jpg" class="img-bg">
	</div>

	</div> <!-- col.// -->
	<div class="col-md-9">
<ul class="row no-gutters bordered-cols">
<c:forEach var="product" items="${Hotbest}">
